            ...
            artikels.slice(0,3).map((artikel) => (
              <article key={artikel.id} className="max-w-sm bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
                ...
                <div className="p-5">
                  ...
                  {/* Title */}
                  <Link href={`/artikel/${artikel.id}`}>
                    <h3 className="text-xl font-medium text-gray-800 mb-3 hover:text-blue-600 transition-colors line-clamp-2">
                      {artikel.judul}
                    </h3>
                  </Link>
...
export default ArtikelRecommendation;