      ...
      >
        <CarouselContent className="-ml-2 md:-ml-4 overflow-visible">
          {items.map((item) => (
            ...
            >
              {type === 'organizational' ? (
                <div className="flex flex-col bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 hover:z-20 overflow-hidden h-72">
                  {item.imageUrl && (
                ...
                <div className="relative rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 hover:z-20 overflow-hidden h-72 group bg-slate-200">
                  <img
